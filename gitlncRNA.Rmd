...
**DF de expresión diferencial**: Son bases de datos creadas por Will, que contiene datos relacionados con la DEG.

-results_full_amp_degs

-results_full_irr_degs

**DF resultados del blast con transcritos antisentido**: Este es el "SelfBlast" es decir que se tomaron los transcritos que codifican para almenos algún péptido y BLAST busco alineamientos con el transcriptoma (es decir con los 400mil transcritos que se obtuvieron con Trinity).

-swissProt_self_blastAStranscripts

**DF con anotaciones:** Contiene todo tipo de anotaciones de BLASTX, prot ID, prot coords, BLASTP, ontología, nombre de los genes, organismos en el que se encuentra, length, etc
...
En el DF "prot" hay columnas que describen como se distribuye el alineamiento lncRNa/mRNA (pocentaje_en\*) específicamente dice qué porcentaje del alineamiento queda en cada una de las zonas. La suma de estas 3 columnas debe dar el 100%.

Modelaje

para un mRNA especifico, podemos observar que la mayoria de lncRNAs con los que se alinea, se alinea en la zona 3UTR. eg.TRINITY_DN82_c1_g1_i1 se alinea con 20 diferentes lncRNAs, de esos alinieamientos, 17 son solo en la zona 3UTR

--------
Ampirr_baseamean contiende valores repetidos ya que algunos RNAs se alinean con diferentes peptidos
skim_variable          n_missing complete_rate       mean      sd      p0     p25      p50   p75
1 log2FoldChange.qer.amp      2398         0.970    0.0738    1.27   -22.1  -0.354  -0.0161  0.428
2 baseMean.qer.amp               0         1     -Inf       NaN     -Inf     2.64    5.29    8.18 
3 log2FoldChange.sub.amp      2340         0.971   -0.00641   0.970  -21.0  -0.437  -0.0566  0.375
4 baseMean.sub.amp               0         1     -Inf       NaN     -Inf     1.06    3.10    5.19 
5 log2FoldChange.qer.irr      2692         0.966    0.0547    1.09   -23.3  -0.337  -0.00200 0.388
6 baseMean.qer.irr               0         1     -Inf       NaN     -Inf     1.84    4.52    7.35 
7 log2FoldChange.sub.irr      3198         0.960    0.130     0.999   -7.70 -0.362   0.0912  0.556
8 baseMean.sub.irr               0         1     -Inf       NaN     -Inf     0.0919  2.29    4.52 
  p100 hist 
1 24.0 ▁▁▇▁▁
2 18.8 ▂▇▇▂▁
3 24.0 ▁▁▇▁▁
